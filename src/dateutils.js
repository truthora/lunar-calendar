...
export function sameMonth(a, b, isLunar) {
  if (!isValidXDate(a) || !isValidXDate(b)) {
    ...
    if (isLunar) {
      ...
      if(b< startFullMoonMonth || b > endFullMoonMonth) {
        return false
      }
...
export function month(date, lunar) {
  if (lunar) {
...
export function page(date, firstDayOfWeek = 0, showSixWeeks = false, lunar = false) {
